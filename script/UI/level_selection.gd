...
func _ready() -> void:
	...
	$"CanvasLayer/Panel/VBoxContainer/lvl 1".pressed.connect(Callable(self, "_on_lvl_1_pressed"))
	$"CanvasLayer/Panel/VBoxContainer/lvl 2".pressed.connect(Callable(self,"_on_lvl_2_pressed"))
	$"CanvasLayer/Panel/VBoxContainer/lvl 3".pressed.connect(Callable(self,"_on_lvl_3_pressed"))
